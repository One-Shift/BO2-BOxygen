<?php
    class newsletters {
        ...
        public function insert() {
            ...
            $query = sprintf("INSERT INTO %s_newsletters (email, code, date) VALUES ('%s','%s','%s')",
                $configuration['mysql-prefix'], $this->email, $this->code, $this->date);
        ...
        public function update () {
            ...
            $query = sprintf("UPDATE %s_newsletters SET email = '%s', code = '%s', date_update = '%s' WHERE id = '%s'",
                $configuration['mysql-prefix'], $this->email, $this->code, $this->date_update, $this->id);
        ...
        public function returnOneRegistry () {
            ...
            $query = sprintf("SELECT * FROM %s_newsletters WHERE id = '%s' LIMIT 1",
        ...
        public function existRegistryByCode () {
            ...
            $query = sprintf("SELECT * FROM %s_newsletters WHERE code = '%s' LIMIT 1",
                $configuration['mysql-prefix'], $this->code);
            $source = $mysqli->query($query);
