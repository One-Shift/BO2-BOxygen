<?php
	class product {
		...
		public function increasePriority() {
			...
			$query = sprintf("UPDATE %s_products SET priority += 1 WHERE id = '%s'", $configuration['mysql-prefix'], $ithis->id);
