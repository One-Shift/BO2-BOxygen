...
<div class="product-list">
    <div class="button-area">
    	...
    	<button onclick="buttonAction ('Confirma?','product-edit');" class="orange"><?php print $language["template"]["edit"] ?></button>
		<button onclick="buttonAction ('Confirma?','product-del');" class="red"><?php print $language["template"]["del"] ?></button>
	</div>
    <table class="db-list">
      <tr>
        <th>#</th>
