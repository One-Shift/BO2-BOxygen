...
<a href="{c2r-path-bo}/0/product/">{c2r-menu-products}</a>
<a href="{c2r-path-bo}/0/order/">{c2r-menu-order}</a>
<a href="{c2r-path-bo}/0/newsletter/">{c2r-menu-newsletters}</a>
<a href="{c2r-path-bo}/0/controller-file/">{c2r-menu-controller-files}</a>
