<div class="product-add">
	...
	<div>
		...
		<div class="bottom-area">
			<input type="checkbox" name="service" /> <?= $language["form"]["label_service"]; ?>
			<br>
			<input type="checkbox" name="published" /> <?= $language["form"]["label_published"]; ?>
			</br>
			<input type="checkbox" name="onhome" /> <?= $language["form"]["label_on_home"]; ?>
			</br>
